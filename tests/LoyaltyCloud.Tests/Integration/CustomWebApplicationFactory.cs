    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["CashierAuth:Issuer"] = "LoyaltyCloud.Tests",
                ["CashierAuth:Audience"] = "LoyaltyCloud.Tests.Cashier",
                ["CashierAuth:AccessTokenMinutes"] = "60",
                ["CashierAuth:SigningKey"] = "test-cashier-auth-signing-key-with-enough-length",
