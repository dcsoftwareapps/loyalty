...
using LoyaltyCloud.Application.Notifications.Queries.ListBirthdayBenefitNotificationCandidates;
using LoyaltyCloud.Application.Notifications.Queries.ListMonthlyProductNotificationCandidates;
using LoyaltyCloud.Application.Notifications.Queries.ListPointCampaignNotificationCandidates;
using LoyaltyCloud.Application.Notifications.Queries.ListPointExpirationNotificationCandidates;
