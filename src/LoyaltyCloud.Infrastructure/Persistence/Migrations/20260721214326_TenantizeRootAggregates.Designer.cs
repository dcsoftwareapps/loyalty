...
namespace LoyaltyCloud.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260721214326_TenantizeRootAggregates")]
    partial class TenantizeRootAggregates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.PointLot", b =>
                {
                    ...
                    b.HasOne("LoyaltyCloud.Domain.Entities.PointTransaction", null)
                        .WithOne()
                        .HasForeignKey("LoyaltyCloud.Domain.Entities.PointLot", "SourcePointTransactionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
