...
namespace LoyaltyCloud.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924021159_AddSelfServiceSignupAttempts")]
    partial class AddSelfServiceSignupAttempts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.BillingSettings", b =>
                {
                    ...
                    b.Property<string>("EmailApplicationBaseUrl")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.GiftCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("ClaimRevoked")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("TenantId", "RecipientMemberId");
            ...
            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.GiftCardConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("AllowCustomAmount")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowPartialRedemption")
                        .HasColumnType("bit");

                    b.Property<bool>("AllowPromotionalIssuance")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ExpirationMode")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
                    ...
                    b.ToTable("GiftCardConfigurations", (string)null);
                });

            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.GiftCardDenomination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "Amount", "Currency")
                        .IsUnique();
            ...
            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.GiftCardTransaction", b =>
                {
                    ...
                    b.HasIndex("TenantId", "GiftCardId", "CreatedAtUtc");

                    b.ToTable("GiftCardTransactions", (string)null);
                });

            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.GiftCardWallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "GiftCardId", "Provider")
                        .IsUnique();

                    b.ToTable("GiftCardWallets", (string)null);
                });
            ...
            modelBuilder.Entity("LoyaltyCloud.Domain.Entities.SelfServiceSignupAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PasswordVerificationHash")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.ToTable("SelfServiceSignupAttempts", (string)null);
                });
