...
namespace LoyaltyCloud.Infrastructure.KeyVault;
...
public static class KeyVaultExtensions
{
    ...
    /// </summary>
    public static IConfigurationBuilder AddLoyaltyCloudKeyVault(this IConfigurationBuilder builder, string? vaultUri)
    {
    ...
    /// </summary>
    public static IServiceCollection AddLoyaltyCloudKeyVaultClient(this IServiceCollection services, string? vaultUri)
    {
